            ...
            <aside className="w-full lg:w-64 bg-white border-r border-slate-100 flex-shrink-0">
                <div className="h-20 flex items-center px-6 border-b border-slate-100">
                    <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-hive-primary rounded-lg flex items-center justify-center text-white font-black text-xl">H</div>
                        <span className="font-black text-xl text-hive-text-primary tracking-tight">HIVE <span className="text-xs font-bold text-hive-primary ml-1 px-1.5 py-0.5 bg-hive-primary/10 rounded">ADMIN</span></span>
                    </div>
                </div>
