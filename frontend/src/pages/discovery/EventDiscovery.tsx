                        ...
                        {isLoading ? (
                            ...
                            <div className="space-y-4 pb-20">
                                {filteredEvents.map(event => (
                                    <DiscoveryEventCard key={event._id} event={event} />
                                ))}
                            </div>
                        )}
                    </div>
                                ...
                                <Marker key={event._id} position={position}>
                                    <Popup>
                                        <div className="p-1 min-w-[200px]">
                                            <div className="font-bold text-hive-text-primary mb-1">{event.title}</div>
                                            ...
                                            <Button size="sm" className="w-full mt-2 h-7 text-[10px]">View Detail</Button>
                                        </div>
                                    </Popup>
                                </Marker>
                            );
...
function DiscoveryEventCard({ event }: { event: any }) {
